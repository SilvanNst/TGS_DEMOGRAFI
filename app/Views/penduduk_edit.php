                ...
                <table class="table table-striped" style="font-weight: bold;">
                  ...
                  <tr>
                    ...
                    <td colspan="2"><select name="jenis_kelamin" class="form-control form-control-sm" data-placeholder="jenis_kelamin" required>
                        ...
                        <option value="Pria" <?php if ($penduduk->jenis_kelamin == "Pria") {
                                                echo "selected=selected";
                                              } ?>>Pria</option>
                        <option value="Wanita" <?php if ($penduduk->jenis_kelamin == "Wanita") {
                                                  echo "selected=selected";
                                                } ?>>Wanita</option>
                      </select></td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td colspan="2"><select name="penduduk_asli" class="form-control form-control-sm" data-placeholder="penduduk_asli" required>
                        <option value="0">--Pilih--</option>
                        <option value="Ya" <?php if ($penduduk->penduduk_asli == "Ya") {
                                              echo "selected=selected";
                                            } ?>>Ya</option>
                        <option value="Tidak" <?php if ($penduduk->penduduk_asli == "Tidak") {
                                                echo "selected=selected";
                                              } ?>>Tidak</option>
                      </select></td>
                  </tr>
