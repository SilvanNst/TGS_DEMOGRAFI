<body>
  ...
  <!-- ======= Header ======= -->
  <header id="header" class="header fixed-top d-flex align-items-center bg-warning fixed-top">

    <div class="d-flex align-items-center justify-content-between">
      <a href="dashboard.php" class="logo d-flex align-items-center">
        <img src="<?= base_url(''); ?>/assets/img/demografi3.png" alt="">
  ...
  <!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar bg-warning fixed-top">
